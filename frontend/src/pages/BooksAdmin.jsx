    ...
    toast(
      (t) => (
        <div className="flex flex-col gap-3">
          <p className="font-medium text-gray-800">Delete this book?</p>
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 bg-red-600 text-white px-3 py-1.5 rounded-lg text-sm font-medium hover:bg-red-700 transition"
            >
              Delete
            </button>
            <button
              onClick={() => toast.dismiss(t.id)}
              className="flex-1 bg-gray-100 text-gray-700 px-3 py-1.5 rounded-lg text-sm font-medium hover:bg-gray-200 transition"
            >
              Cancel
            </button>
          </div>
          ...
          >
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                {[
                  { label: "All Books", val: 0 },
                  { label: "Published", val: 1 },
                  { label: "Unpublished", val: 2 },
                ].map((opt) => (
                  <label
                    key={opt.val}
                    style={{
                      ...
                      cursor: "pointer",
                      fontSize: 13,
                      color: isPublished === opt.val ? "#2563eb" : "#374151",
                      fontWeight: isPublished === opt.val ? 600 : 400,
                    }}
                  >
                    <input
                      type="radio"
                      name="status"
                      checked={isPublished === opt.val}
                      onChange={() => setIsPublished(opt.val)}
